      ...
      <div>
        <Navbar expand="md" color="light" className="menu mb-4">
          <Nav className="mr-lg-auto" navbar>
            ...
            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/basics/">
                Basics
              </NavLink>
            </NavItem>

            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/functions/">
                Functions
              </NavLink>
            </NavItem>

            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/datatypes/">
                Data Types
              </NavLink>
            </NavItem>
            ...
            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/namespaces/">
                Namespaces
              </NavLink>
            </NavItem>

            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/concurrency/">
                Concurrency
              </NavLink>
            </NavItem>

            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/effects/">
                Effects
              </NavLink>
            </NavItem>

            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/fixpoints/">
                Fixpoints
              </NavLink>
            </NavItem>

            <NavItem className="pl-1 pr-1">
              <NavLink tag={Link} to="/interoperability/">
                Interoperability
              </NavLink>
            </NavItem>
        ...
        <div id="page">
          <Route
            path="/"
            exact
            render={() => <Welcome flix={this.getFlix()} />}
          />
          <Route
            path="/introduction/"
            render={() => <Introduction flix={this.getFlix()} />}
          />
          <Route
            path="/basics/"
            render={() => <Basics flix={this.getFlix()} />}
          />
          <Route
            path="/functions/"
            render={() => <Functions flix={this.getFlix()} />}
          />
          <Route
            path="/datatypes/"
            render={() => <DataTypes flix={this.getFlix()} />}
          />
          <Route
            path="/lists/"
            render={() => <Lists flix={this.getFlix()} />}
          />
          <Route
            path="/records/"
            render={() => <Records flix={this.getFlix()} />}
          />
          <Route
            path="/namespaces/"
            render={() => <Namespaces flix={this.getFlix()} />}
          />
          <Route
            path="/concurrency/"
            render={() => <Concurrency flix={this.getFlix()} />}
          />
          <Route
            path="/effects/"
            render={() => <Effects flix={this.getFlix()} />}
          />
          <Route
            path="/fixpoints/"
            render={() => <Fixpoints flix={this.getFlix()} />}
          />
          <Route
            path="/interoperability/"
            render={() => <Interoperability flix={this.getFlix()} />}
          />
          <Route
            path="/build/"
            render={() => <Build flix={this.getFlix()} />}
          />
        </div>
      </div>
    )
