...
export class CustomHighlightRules extends window.ace.acequire("ace/mode/text_highlight_rules").TextHighlightRules {
    constructor() {
        ...
        var keywords = (
            "case|def|else|enum|if|lat|let|match|rel|select|spawn|with|namespace|pub|not|type|alias|use|import|get|set|new|as|ref|deref|inject|into|from|where|query|solve|instance"
        );
